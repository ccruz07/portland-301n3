(function(module) {
  ...
  // COMMENT: What does this method do?   ANS:dont' understand this method- maybe it populates the map function and attaches to the author
  // What is it's execution path?         ANS: utilizes the options the get the authors
  ...
  // COMMENT: What does this method do?    ANS: jQuery runs function once, runs eventListner when select changes, then run next function
  //What is it's execution path?           ANS: IDK???? maybe it goes through webdb.js
  ...
  // COMMENT: What does this method do?    ANS: get articles with id. show elements w/id. does not make sense after show().
